    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          ListTile(
            title: const Text('Reel Video Player'),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const ReelPage()),
              );
            },
          ),
          ListTile(
            title: const Text('Decrypt Video Player'),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const DecryptPage()),
              );
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => const FromNetworkPage()),
              );
            },
          ),
          ListTile(
...
class DecryptPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromRGBO(246, 245, 250, 1),
      appBar: AppBar(
        title: const Text('Decrypt Player'),
        leading: IconButton(
          icon: const Icon(Icons.arrow_back),
          onPressed: () => Navigator.pop(context),
        ),
      ...
      body: SafeArea(
        child: Center(
          child: SizedBox(
            width: MediaQuery.of(context).size.width,
            height: 250,
            child: const DecryptVideoPlayer(),
          ),
        ),
      ),
    );
