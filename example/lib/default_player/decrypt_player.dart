...
class DecryptVideoPlayer extends StatefulWidget {
  const DecryptVideoPlayer({Key? key}) : super(key: key);

  @override
  State<DecryptVideoPlayer> createState() => DecryptVideoPlayerState();
}

class DecryptVideoPlayerState extends State<DecryptVideoPlayer>
        ...
        source: {
          for (var i = 0; i < Environment.resolutionsUrls.length; i++)
            Environment.resolutionsUrls[i].quality: VideoSource(
              ...
              httpHeaders: customHeaders,
              subtitle: {
                "English": KenjiPlayerSubtitle.decrypt(
                  "https://cdn.cdn3.co/storage/subtitle/f2da76bb-25a0-45ee-b0cc-12266fc3c7b8.vtt",
